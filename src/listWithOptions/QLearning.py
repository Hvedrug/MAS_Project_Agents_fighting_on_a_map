...
def getTrainedAgentFromFile(filename):
	...
	return q_table, int(info[0]), int(info[1]), int(info[2])

def saveQTableToFile(q_table, num_row, num_col, num_agents, filename):
	f = open(filename, "w")
	data = ""
